<x-app-layout>
    ...
    <div class="mb-4">
        ...
        <div class="mt-4">
            <p class="text-sm text-red-500 font-medium mb-1">Comment Moderator</p>
            <label class="block text-lg font-medium text-gray-600">{{$post->moderator_comments}}</label>
        </div>
    </div> 
    </div>
    <div class="flex justify-center space-x-4">
        <a href="{{ route('moderator.index', $post->id)}}" class="bg-green-500 text-white px-6 py-3 rounded-lg hover:bg-green-600 transition duration-300 inline-flex items-center justify-center">
            Back
        </a>
